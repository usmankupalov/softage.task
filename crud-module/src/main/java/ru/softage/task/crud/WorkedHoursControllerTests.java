...
public class WorkedHoursControllerTests {
    ...
    public void getExistingHoursByWorkerId(){
        ...
        assertThat(entity.startDate).isEqualTo(Date.from(Instant.parse("2021-02-17T09:00:00Z")));
        assertThat(entity.finishDate).isEqualTo(Date.from(Instant.parse("2021-02-17T23:00:00Z")));
    }
