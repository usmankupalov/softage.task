...
@NamedNativeQueries({
        ...
        @NamedNativeQuery(
                name = FIND_WORKED_HOURS_BY_WORKED_ID,
                query = "SELECT * worker_hours" + "WHERE worker_id = :" + PARAMETER_ID,
                resultClass = WorkedHoursEntity.class),
        @NamedNativeQuery(
                name = DELETE_WORKED_HOURS_BY_WORKER_ID,
                query = "DELETE FROM worked_hours" + "WHERE worker_id = : " + PARAMETER_ID)
})
public class WorkedHoursEntity implements AbstractEntity{
    public static final String FIND_WORKED_HOURS  =               "FIND_WORKED_HOURS";
    public static final String FIND_WORKED_HOURS_BY_WORKED_ID =   "FIND_WORKED_HOURS_BY_WORKED_ID";
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WorkedHoursEntity)) return false;
