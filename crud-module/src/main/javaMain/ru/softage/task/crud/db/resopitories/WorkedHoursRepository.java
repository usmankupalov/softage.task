package ru.softage.task.crud.db.resopitories;
...
import static jdk.internal.net.http.frame.ErrorFrame.INTERNAL_ERROR;
...
public class WorkedHoursRepository  extends CommonRepository <WorkedHoursEntity>{
    ...
    public WorkedHoursEntity findById(Long id) {
        ...
        throw new ServiceException(INTERNAL_ERROR,
                "Method 'findById' must not be called from WorkedHoursController " );
    }
    ...
    public List<WorkedHoursEntity> findByWorkerId(Long workerId){
        ...
        List<WorkedHoursEntity> list = em.createNamedQuery(FIND_WORKED_HOURS_BY_WORKED_ID,
                WorkedHoursEntity.class).setParameter(PARAMETER_ID, workerId).getResultList();
